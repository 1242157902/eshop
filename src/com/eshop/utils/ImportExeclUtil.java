...
{  
    ...
    public static final ImportExeclUtil  instance = new ImportExeclUtil();
    public static synchronized ImportExeclUtil getInstance()
    {
    	return instance;
    }
  ...
  /*      File file = new File(filePath);  
    ...
    public List<List<String>> readExcelData(InputStream is,String filePath)
    {
    	   List<List<String>> dataLst = new ArrayList<List<String>>();  
           try  
           {  
    ...
    {  
        ...
        //List<List<String>> list = poi.read("e:/2.xls");  
