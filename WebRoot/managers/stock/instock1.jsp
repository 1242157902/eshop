...
$(function(){
	...
	$('#t_user').datagrid({
				...
				title:'入库单信息' , 
				fitColumns: true  ,
				url:'instock/findAllInStock1.do' ,				//修改请求的url
				striped: true ,					
								...
								$.messager.confirm('提示信息' , '确认入库?' , function(r){
									if(r){
										...
										instock_ids = instock_ids.substring(0,instock_ids.length-1);
								 		$.post('instock/insertStock.do' , {instock_ids:instock_ids},function(result){
  ...
  <body>
	...
	<div id="cc" class="easyui-layout"  fit=true style="width:100%;height:100%;">  
		   <div region="north"   title="" split="false" style="height:100px;text-align: left;"  >
		    ...
		    <div region="center"   >
			  		<table id="t_user"   style="width: 100%;height:70%;"></table>
		    </div>  
