                ...
                <div class="brand-class">
                    ...
                    <c:choose>
                      ...
                      <ul id="proBrandlist" class="class-type">
                        ...
                        <li>
                        <a id="bid-1" href="good/lookMerchById.do?c_id=-1&c_parent=${c_parent}&pagenum=1" class="xz">全部</a>
                        </li>
                      <c:forEach items="${secondCategories}" var="category" varStatus="status">
                      
                        <li>
                        <a id="bid_${status.index+1}" href="good/lookMerchById.do?c_id=${category.c_id }&c_parent=${c_parent}&pagenum=1">${category.c_name}</a>
                        </li>
                      </c:forEach>   
                    </ul>
                      ...
                      <ul id="proBrandlist" class="class-type">
                        ...
                        <li>
                        <a id="bid-1" href="good/lookMerchById.do?c_id=-1&c_parent=${c_parent}&pagenum=1" >全部</a>
                        </li>
                      <c:forEach items="${secondCategories}" var="category" varStatus="status">
                      <c:choose>
                        <c:when test="${c_id==category.c_id }">
                        <li>
                        <a  class="xz"  id="bid_${status.index+1}" href="good/lookMerchById.do?c_id=${category.c_id }&c_parent=${c_parent}&pagenum=1">${category.c_name}</a>
                        </li>
                       </c:when>
                       <c:otherwise>
                       <li >
